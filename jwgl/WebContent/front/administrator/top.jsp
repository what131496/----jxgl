...
<html>
	...
	<style>
		...
		.top-menu{ width: 325px; margin-left: 1060px; margin-top: -78px;
		...
		.semester{color:white;margin-bottom: 6px;}
	</style>
	<body>
		<div class="top-main clearfix">
			...
			<div class="top-menu">
				...
				<span><img src="../img/index/user1.png"/><b>管理员：<s:property value="#session.exitUsers.getUserName()" /></b></span>
