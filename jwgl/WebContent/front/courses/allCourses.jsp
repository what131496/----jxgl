		...
		<div class="info">
			<table class="datatable" border="1" width="780">
				...
				<tr>
					...
					<td align="center"><a
						href="${pageContext.request.contextPath}/Courses_modify.action?cour_id=<s:property value="#d.cour_id"/>"><img
						src="${pageContext.request.contextPath}/front/img/edit.png"></a></td>
					<td align="center"><a
						href="${pageContext.request.contextPath}/Courses_delete.action?cour_id=<s:property value="#d.cour_id"/>"><img
						src="${pageContext.request.contextPath}/front/img/delete.jpg" onclick="return confirm('确认删除吗？')"></a></td>
				</tr>
			</s:iterator>
			</table>
			<br />
