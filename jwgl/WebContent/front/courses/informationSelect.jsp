		...
		<div class="info">
			<table class="datatable" border="1" width="780">
				...
				<tr>
					...
					<td align="center"><a
						href="${pageContext.request.contextPath}/CourseScore_unselect.action?cour_id=<s:property value="#d.cour_id"/>"><img
						src="${pageContext.request.contextPath}/front/img/edit.png">退选</a></td>
				</tr>
			</s:iterator>
			</table>
	</div>
